<?php
 ...
 $slug = requestInput('slug');
 $sql = "SELECT * FROM view_musics WHERE music_slug = '$slug'";
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo site_url('public/player.css');?>">
    <style>
        .comment-user-answer {
            display: flex;
...
<body>
            ...
            <div class="music-hero">
                ...
                <div class="music-info-section">
                    ...
                    <div class="artist-info">
                        <img src="<?php echo site_url($music['artist_avatar']); ?>" alt="Artist Avatar" class="artist-avatar-small">
                        <div>
    ...
    <script src="<?php echo site_url('js/jquery-3.7.1.min.js');?>"></script>
    <script src="<?php echo site_url('js/toaster.js');?>"></script>
    <script src="<?php echo site_url('js/script.js');?>"></script>
    <script src="<?php echo site_url('js/player.js');?>"></script>
</body>
</html>